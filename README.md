...
![Add-on Version](https://img.shields.io/badge/Add--on-v1.11.7-blue)
...
точки; для отдельных снимков траектории и старых журналов интерфейс восстанавливает их по прогрессу FakeGPS
на захваченной геометрии и соседним снимкам, не соединяя разные маршруты и
интервалы без FakeGPS. Если в поездке не было захваченного маршрута и FakeGPS,
географическую рулевую линию построить нельзя; интерфейс прямо сообщает об этом.
