...
![Add-on Version](https://img.shields.io/badge/Add--on-v1.8.0-blue)
![HA Ingress](https://img.shields.io/badge/HA-Ingress%20Supported-brightgreen)

Репозиторий официального дополнения **X50 Navigation Simulator** (версия **`1.8.0`**) для Home Assistant.
