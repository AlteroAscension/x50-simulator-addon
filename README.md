...
![Add-on Version](https://img.shields.io/badge/Add--on-v1.7.1-blue)
![HA Ingress](https://img.shields.io/badge/HA-Ingress%20Supported-brightgreen)

Репозиторий официального дополнения **X50 Navigation Simulator** (версия **`1.7.1`**) для Home Assistant.
